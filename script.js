...
function submitExamFinish(){
  ...
  // تأكد من وجود مصفوفة الإجابات الصحيحة
  if(state.currentExam.mode==='training' && !state.currentExam.firstAnswers){
    state.currentExam.firstAnswers = state.currentExam.answers.slice();
  }
